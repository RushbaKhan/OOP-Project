		...
		while (EditBan >> nic >> fname >> phoneNumber >> current_adress >> Password >> ban >> reason)
		{
			if (nic == tempnic)
			{
				...
				cout << "Name " << fname << endl
					 << "Enter 2 to ban this account or 1 to unban: ";
				cin >> ban;
				while (ban >= 2 && ban <= 1)
				{
	...
	void login(string password, string Cnic)
	{
		...
		while (login >> nic >> fname >> lname >> phoneNumber >> current_adress >> Password >> ban >> reason)
		{
			if (Password == password && nic == Cnic)
			{
				...
				{
					cout << "You are banned from the website for: " << endl
						 << reason << endl
						 << "To appeal your ban please contact the administrator" << endl;
				}
			}
		}
	}
...
{
	system("color F2");
	loader("ZAMEEN.com  HAR PATA HUME PATA HAI");
	menu();
	return 0;
}
...
void adminOptions(Admin b)
{
	...
	while (option != 4)
	{
		cout << "1-Press 1 to view user accounts" << endl
			 << "2-Press 2 to ban an account" << endl;
		cin >> option;
		system("cls");
...
void displayads()
{
	cout << "\t\t___________  VIEW ALL" << endl;
	cout << "|                         |\t|                         |\t|                              |" << endl;
	cout << "|PKR 32.1 lac to 1.2 crore|\t|PKR 41.3 lakh to 1.1 crore|\t|PKR 79 lac to 2.8 crore       |" << endl;
	cout << "|                         |\t|                         |\t|                              |" << endl;
